...
> Android Termux package built from upstream OpenAI Codex `rust-v0.146.1`.

This package metadata covers the Termux-focused
`@mmmbuto/codex-cli-termux` line. Version `0.146.1` is released only from the
...
- Built from upstream `rust-v0.146.1`
